...
function ProjectCard({ title, desc1, tech, isDark, link = "#", onHover, bgLight, bgDark }) {
  return (
      ...
      <div className={`flex-1 overflow-y-auto px-5 md:px-8 py-6 relative custom-scroll transition-colors duration-300 ${isDark ? 'bg-[#111d28]/95' : 'bg-[#f7fbff]/95'}`}>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-8">
            ...
            <a href="#" className={`text-[14px] font-bold flex items-center gap-1 hover:underline ${isDark ? 'text-gray-300' : 'text-[#444]'}`}>
              View all 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <ProjectCard 
              ...
              isDark={isDark}
              bgLight="bg-[#f2efff]" // light lavender
              bgDark="bg-[#242133]"
            />
            ...
            <ProjectCard 
              onHover={() => playSound('hover_icon')}
              title="GVoice CRM"
              desc1="I developed the Super Admin Panel, login flow, company management screens, user management modules, and dashboards."
              tech="Node.js, React.js, PostgreSQL"
              isDark={isDark}
              bgLight="bg-[#fff1ed]" // light peach/orange
              bgDark="bg-[#33221e]"
            />
            ...
            <ProjectCard 
              onHover={() => playSound('hover_icon')}
              title="GVoice HRMS"
              desc1="An HRMS application focused on employee management and HR workflows. I contributed to attendance, leave, and payroll."
              tech="Next.js, Node.js, PostgreSQL"
              isDark={isDark}
              bgLight="bg-[#eefcf2]" // light green
              bgDark="bg-[#1b2b20]"
            />
            ...
            <ProjectCard 
              onHover={() => playSound('hover_icon')}
              title="Catalyst"
              desc1="A financial and investment management platform. I contributed to dashboard development, data visualization, and API integration."
              tech="React.js, PostgreSQL, Tailwind"
              isDark={isDark}
              bgLight="bg-[#eff8ff]" // light blue
              bgDark="bg-[#1b2633]"
            />
          </div>
          ...
          <div className={`mt-8 p-6 rounded-2xl border text-center transition-colors duration-300 ${isDark ? 'bg-[#172637] border-white/10' : 'bg-white border-[#eef2f6]'}`}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
              <a href="https://github.com/panchalurvisha" target="_blank" rel="noopener noreferrer" className={`flex items-center justify-center gap-2.5 font-bold px-6 py-3 rounded-xl transition-all duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-md ${isDark ? 'bg-white text-black hover:bg-gray-200' : 'bg-[#181717] text-white hover:bg-[#333]'}`}>
              ...
              <a href="https://www.linkedin.com/in/urvisha-panchal-9423933b9/" target="_blank" rel="noopener noreferrer" className={`flex items-center justify-center gap-2.5 font-bold px-6 py-3 rounded-xl transition-all duration-300 transform hover:-translate-y-1 shadow-sm hover:shadow-md ${isDark ? 'bg-[#0A66C2] text-white hover:bg-[#004182]' : 'bg-[#0A66C2] text-white hover:bg-[#004182]'}`}>
                <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
